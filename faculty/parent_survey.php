    ...
    <tr>
        ...
        if(isset($_POST['filter'])){
            if(($rg == "" )){
                ...
                $sql=mysqli_query($conn,"select * from parentsurvey where department ='$_SESSION[department]'");
            }
           /* elseif(($chac !== "" )&&($chdept =="")){
            ...
            elseif(($chac == "" )&&($chdept !="")){
                ...
                $sql=mysqli_query($conn,"select * from parentsurvey where Regno='$rg' and department ='$_SESSION[department]'");
