...
extract($_POST);
	...
	{ 	
		...
		echo "<td class='text-center'><a href='dashboard.php?dept=$row[department]&cc=$row[coursecode]&ac=$row[acyear]&page=edit_faculty'><span class='fa fa-pencil'style=color:green;></span></a></td>";
		
		
		echo "<td class='text-center'><a href='dashboard.php?id=$row[coursecode]&page=delete_faculty'><span class='fa fa-trash' style=color:red;></span></a></td>";
