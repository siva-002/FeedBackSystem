...
<?php
	if(isset($_POST['civil'])){
		$value= "CIVIL";
		$tb="feedback-civil-".$chac;
	}
	elseif(isset($_POST['cse'])){
		$value= "CSE";
		$tb="feedback-cse-".$chac;
	}elseif(isset($_POST['mech'])){
		$value="MECH";
		$tb="feedback-mech-".$chac;
	}elseif(isset($_POST['ece'])){
		$value="ECE";
		$tb="feedback-ece-".$chac;
	}?>
<div id="main">
	<?php
	...
	if((isset($_POST['civil'])) or (isset($_POST['cse'])) or (isset($_POST['mech'])) or (isset($_POST['ece'])) ){
	    	$_SESSION['tb']=$tb;
	...
	echo "<h2><strong>".$value ."&nbsp;". @$chac."</strong>  FEEDBACKS  ( <b>".$count."</b> ) Students <b>( 
...
<form action="" method="post">
	...
	<button type="submit" class="btn" name="civil">CIVIL</button><br>
	<br>
